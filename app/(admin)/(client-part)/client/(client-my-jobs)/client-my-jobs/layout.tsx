    ...
    return (
        <div className='p-6'>
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-3">
                ...
                <button className="w-fit flex items-center gap-1.5 bg-[#111927] text-white cursor-pointer  md:px-4 md:py-[17px] px-4 py-2 rounded-[12px]">
                    <Plus /> Post a Job
                </button>
            </div>
            {/* Reusable Line Tabs */}
            <ReusableLineTabs tabs={TabsData} currentPath="/client/client-my-jobs/short-term-job" />
            {/* Children */}
