    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <button className="px-4 py-2 text-sm border border-red-200 text-red-600 rounded-lg hover:bg-red-50 transition cursor-pointer flex items-center gap-1">
            ...
            <DialogContent className="w-full max-w-[620px]! p-6">
                <DialogHeader>
                    <DialogTitle className="text-xl text-center font-semibold tracking-tight">
                        {
                            cancelTime ? "Cancellation Time Limit Exceeded" : "Are you sure to cancel this job?"
                        }

                    </DialogTitle>
                    <DialogDescription className="text-base text-muted-foreground  text-center mt-1 ">
                        {
                            cancelTime ? "Free cancellation is available before 8 hours. This time has passed. A cancellation fee will be charged if you proceed. Would you like to proceed?" : " This action cannot be undone, and you'll need to reschedule if you change your mind."
                        }
                    </DialogDescription>
                </DialogHeader>
