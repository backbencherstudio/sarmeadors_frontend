            ...
            >
                {file ? (
                    ...
                    <>
                        ...
                        <p className="text-sm font-medium text-[#778593]">Supported files: PDF, JPG, PNG</p>
                        <button
    ...
    return (
        <CommonAccordion title="Name, Logos, Colors and Font">
            ...
            <div className="flex gap-4">
                <DropZone label="Upload Logo" file={logoFile} onFileChange={setLogoFile} />
                <DropZone label="Favicon" file={faviconFile} onFileChange={setFaviconFile} />
            </div>
