...
import { useUploadCandidateAdditionalDocumentMutation } from "@/feature/slice/candidate/candidate-dashboard/candidateDocumentSlice";
...
function CandidateAdditonalDocumentUploadFrom({
  open,
  setOpen,
}: {
  open: boolean;
  ...
  const [uploadCandidateAdditionalDocument, { isLoading }] =
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      const response = await uploadCandidateAdditionalDocument({
        data: formData,
      }).unwrap();
...
export default CandidateAdditonalDocumentUploadFrom;
